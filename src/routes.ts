...
import {
  getMoneyTransfers,
  postMoneyTransfer,
} from './controllers/money-transfer.controller';
...
export class Routes {
  ...
  public routes(app: express.Application): void {
    ...
    app.route('/profile/portfolio').get(authenticateRequest(), getPortfolios);
    ...
    app
      ...
      .delete(
        authenticateRequest(),
        this.validator.params(portfolioIdWithTransactionIdSchema),
        ensurePortfolioOwnership(),
        deleteTransaction
      );
  }
